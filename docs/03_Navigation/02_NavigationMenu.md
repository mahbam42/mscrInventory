...
The navigation menu appears at the top of the screen and contains the primary sections of the app:
...
| **Manage Users** | Assign or update user permissions. |
| **Admin** | Django Admin system for advanced users. |
