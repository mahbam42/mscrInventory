...
def test_get_top_named_drinks_aggregates_recent_entries():
    ...
    OrderItemFactory(
        ...
        product=product_a,
        quantity=2,
        variant_info={"modifiers": ["name your drink spooky special", "extra caramel"]},
    )
    OrderItemFactory(
        order=recent_order,
        product=product_a,
        quantity=1,
        variant_info={"modifiers": ["name your drink spooky special"]},
    )
    OrderItemFactory(
        order=another_order,
        product=product_b,
...
def test_get_top_named_drinks_ignores_out_of_window_and_noise():
    ...
    OrderItemFactory(
        order=current_order,
        variant_info={"modifiers": ["almond milk", "name your drink fresh start"]},
    )
    OrderItemFactory(
        order=current_order,
